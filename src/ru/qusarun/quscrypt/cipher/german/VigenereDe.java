...
public class VigenereDe extends Cipher {
    ...
    public char map(final int i) { return CharUtil. DE_ALPHABET.charAt(i >= 0 ? i % CharUtil. DE_ALPHABET.length() : (26 + i % CharUtil. DE_ALPHABET.length()) % CharUtil. DE_ALPHABET.length()); }
