...
public class VigenereRu extends Cipher {
    ...
    public char map(final int i) { return CharUtil.RU_ALPHABET.charAt(i >= 0 ? i % CharUtil.RU_ALPHABET.length() : (33 + i % CharUtil.RU_ALPHABET.length()) % CharUtil.RU_ALPHABET.length()); }
